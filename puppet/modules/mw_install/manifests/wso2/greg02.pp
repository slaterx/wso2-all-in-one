class mw_install::wso2::greg02 {
    ...
    mw_install::filecopy { "wso2greg-5.1.0_wso2greg02":
        file          => "wso2greg-5.1.0",
        origin        => "/opt/wso2",
        destination   => "/opt/wso2/wso2greg02",
        user          => "root",
        group         => "root",
    ...
    file { "/opt/wso2/wso2greg02/repository/components/lib/mysql-connector-java-5.1.38-bin.jar":
        mode    => 644,
        owner   => "root",
        group   => "root",
    ...
    file { '/opt/wso2/wso2greg02/bin/wso2server.sh':
        mode    => 755,
        owner   => "root",
        group   => "root",
        content => template('mw_install/wso2greg-5.1.0/bin/wso2server.sh.erb'),
        #require => File["/opt/wso2/wso2greg02"],
    } -> 

    # Template for the master datasource configuration
    file { '/opt/wso2/wso2greg02/repository/conf/datasources/master-datasources.xml':
        mode    => 644,
        owner   => "root",
        group   => "root",
    ...
    file { '/opt/wso2/wso2greg02/repository/conf/user-mgt.xml':
        mode    => 644,
        owner   => "root",
        group   => "root",
    ...
    file { '/opt/wso2/wso2greg02/repository/conf/carbon.xml':
        mode    => 644,
        owner   => "root",
        group   => "root",
    ...
    file { '/opt/wso2/wso2greg02/repository/conf/tomcat/catalina-server.xml':
        mode    => 644,
        owner   => "root",
        group   => "root",
