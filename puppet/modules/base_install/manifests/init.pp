...
# Disabled services
    ...
    file { "sshd_config":
        ...
        owner   => "root",
        group   => "root",
        source => "puppet:///modules/base_install/sshd_config",
        require => Package["openssh-server"],
    }
    ...
    file { "ntp_config":
        ...
        owner   => "root",
        group   => "root",
        source => "puppet:///modules/base_install/ntp.conf",
        require => Package["ntp"],
    }
    ...
    file { '/etc/issue':
        ...
        group => "root",
        mode => 644,
        source => "puppet:///modules/base_install/etc_issue",
    }
    ...
    file { 'iptables_config':
        ...
        group => root,
        mode => 600,
        source => "puppet:///modules/base_install/iptables",
